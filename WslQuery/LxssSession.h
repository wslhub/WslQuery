...
static const GUID FAR CLSID_LxssUserSession = {
	0x4F476546,
	0xB412,
	0x4579,
	{ 0xB6, 0x4C, 0x12, 0x3D, 0xF3, 0x31, 0xE3, 0xD6 } };

static const GUID FAR IID_ILxssUserSession = {
	0x536A6BCF,
	0xFE04,
	0x41D9,
...
typedef enum _WSL_DISTRIBUTION_FLAGS {
	WSL_DISTRIBUTION_FLAGS_NONE = 0u,
	WSL_DISTRIBUTION_FLAGS_ENABLE_INTEROP = 1u,
	WSL_DISTRIBUTION_FLAGS_APPEND_NT_PATH = 2u,
	WSL_DISTRIBUTION_FLAGS_ENABLE_DRIVE_MOUNTING = 4u,
	WSL_DISTRIBUTION_FLAGS_DEFAULT = 7u
